...
const _strings = <String, Map<String, String>>{
  ...
  'currency_suffix':       {'uz': "so'm",                'ru': 'сум'},
  ...
  'download':              {'uz': 'Yuklash',             'ru': 'Скачать'},
  'project_report_title':  {'uz': "Obyekt bo'yicha hisob-kitob", 'ru': 'Расчет по объекту'},
  'expense_distribution':  {'uz': 'Chiqimlar taqsimoti', 'ru': 'Распределение расходов'},
  ...
  'create_notification':   {'uz': 'Yangi bildirishnoma', 'ru': 'Новое уведомление'},
  'title_uz_label':        {'uz': 'Sarlavha (O\'zbekcha)', 'ru': 'Заголовок (Узбекский)'},
  'body_uz_label':         {'uz': 'Xabar matni (O\'zbekcha)', 'ru': 'Текст сообщения (Узбекский)'},
  'title_ru_label':        {'uz': 'Sarlavha (Ruscha)',   'ru': 'Заголовок (Русский)'},
  'body_ru_label':         {'uz': 'Xabar matni (Ruscha)',  'ru': 'Текст сообщения (Русский)'},
  'recipient':             {'uz': 'Qabul qiluvchi',      'ru': 'Получатель'},
  'all_users':             {'uz': 'Barcha foydalanuvchilar', 'ru': 'Все пользователи'},
  'send':                  {'uz': 'Yuborish',            'ru': 'Отправить'},
  'fields_required_error':  {'uz': 'Iltimos, barcha maydonlarni to\'ldiring', 'ru': 'Пожалуйста, заполните все поля'},
};
