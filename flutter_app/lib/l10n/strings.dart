...
const _strings = <String, Map<String, String>>{
  ...
  'upload_image':          {'uz': 'Rasm yuklash',        'ru': 'Загрузить фото'},
  'file_name_title':       {'uz': "Fayl nomi",           'ru': 'Имя файла'},
  'original_file_name':    {'uz': "Asl nomi",            'ru': 'Оригинальное имя'},
  'given_file_name':       {'uz': "Faylga beriladigan nom", 'ru': 'Название для файла'},
  'file_name_hint':        {'uz': "Nom kiriting...",     'ru': 'Введите название...'},
  'attach_files':          {'uz': 'Fayllar biriktirish', 'ru': 'Прикрепить файлы'},
  'attached_files':        {'uz': 'Biriktirilgan fayllar', 'ru': 'Прикрепленные файлы'},
  'select_files_title':    {'uz': 'Fayl biriktirish',     'ru': 'Выбрать файлы'},
  'confirm_selection':     {'uz': 'Tanlash ({})',         'ru': 'Выбрать ({})'},
  'open_external':         {'uz': "Brauzerda ochish",    'ru': 'Открыть в браузере'},
  'image_load_error':      {'uz': "Rasm yuklanmadi",     'ru': 'Ошибка загрузки изображения'},
  ...
  'income_by_category':    {'uz': 'Kategoriyalar bo\'yicha kirim',  'ru': 'Доход по категориям'},
